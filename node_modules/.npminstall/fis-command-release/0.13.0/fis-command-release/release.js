...
exports.register = function(commander){
    ...
    function watch(opt){
        ...
        // init cache
        var files = fis.project.getSource(); //返回fis.file对象包装过的数组
    ...
    commander
        ...
        .action(function(){
            ...
            var options = arguments[arguments.length - 1]; //action方法的参数
            ...
            if(options.root){
                ...
                root = fis.util.realpath(process.cwd()); //用当前工作目录作为root
                if(!conf){
